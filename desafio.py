...
def criar_conta(agencia, numero_conta, usuarios):
    ...
    if usuario:
        ...
        # Inicializa a conta com saldo, extrato e numero_saques
    ...
    while True:
        ...
        if opcao == "d":
            ...
            if conta:
                ...
                # Aqui o limite de 500 é fixo por enquanto, mas poderia ser um valor por conta
                conta['saldo'], conta['extrato'], conta['numero_saques'], _ = sacar(
                    saldo=conta['saldo'],
                    valor=valor,
                    extrato=conta['extrato'],
                    limite=500,  # Limite de R$500 por saque, não é o limite de cheque especial
